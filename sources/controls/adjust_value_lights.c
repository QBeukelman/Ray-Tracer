...
/*   Updated: 2025/05/04 18:05:09 by quentinbeuk   ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */

#include "../../includes/minirt.h"

static void	adjust_position(t_light *point_light, t_edit edit, int delta)
{
...
void	adjust_value_point_light(t_scene *scene, int delta)
{
	if (scene->edit.editing_prop == O_POSITION)
		adjust_position(&scene->light, scene->edit, delta);
}
